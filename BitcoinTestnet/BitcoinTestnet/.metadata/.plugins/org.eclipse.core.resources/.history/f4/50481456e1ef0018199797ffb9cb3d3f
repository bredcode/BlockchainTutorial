            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    for(var i = 0 ; i < session_arr.length; i++){
                        ...
                        var html = "<a class=\"list-group-item list-group-item-action\">"+"nodeid:"+id+"/rpcport="+rpcport+"<input class='idx' type='hidden' value='"+i+"'></a>";
